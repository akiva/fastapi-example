...
def test_create_note(test_app, monkeypatch):
    ...
    async def mock_post(db, payload):
        return 1
...
def test_read_all_notes(test_app, monkeypatch):
    ...
    async def mock_list(db):
        return test_data
    monkeypatch.setattr(service, 'list', mock_list)
...
def test_update_note(test_app, monkeypatch):
    ...
    async def mock_get(db, id):
        return True
    async def mock_put(db, id, payload):
        return 1
    monkeypatch.setattr(service, 'get', mock_get)
...
def test_remove_note(test_app, monkeypatch):
    ...
    async def mock_get(db, id):
        return test_data
    async def mock_delete(db, id):
        return id
    monkeypatch.setattr(service, 'get', mock_get)
    monkeypatch.setattr(service, 'delete', mock_delete)
